function getContentCSS() {
  ...
  return `
    <style>
        a{color: rgb(35,35,35); font-size: 13px; font-weight: 600;}
        h1{font-size: 18px; font-weight: bold; padding: 0; margin: 0;}
        h6{font-size: 12px; font-weight: bold; padding: 0; margin: 0;}
        p{font-size: 12px; font-weight: normal; padding: 0; margin: 0;}
        div:not(:first-child){font-size: 13px; margin:16px 0; }
        div:first-child{font-size: 13px; margin-bottom:16px; margin-top: -8px }
        ul{padding: 0 16px; margin: 0}
        ol{padding: 0 16px; margin: 0}
        li{font-size: 13px; margin-left:16px}
        video {max-width: 100%; margin-left:auto; margin-right:auto; display: block;}
        img {max-width: 100%; vertical-align: middle; display: inline; height: auto;}
        ...
        blockquote{border-left: 2px solid rgb(0,0,0); padding: 0 0 0 12px; margin: 0; margin-left:13px; font-size: 12px; font-style: italic;}
        hr{display: block;height: 0; border: 0;border-top: 1px solid rgb(204,204,204); margin: 15px 0; padding: 0;}
        pre{padding: 10px 5px 10px 10px;margin: 15px 0;display: block;line-height: 18px;background: rgb(240,240,240);border-radius: 6px;font-size: 13px; font-family: 'monaco', 'Consolas', "Liberation Mono", Courier, monospace; word-break: break-all; word-wrap: break-word;overflow-x: auto;}
    ...
    var _ = (function (exports) {
        ...
        var Actions = {
            ...
            UPDATE_HEIGHT: function() {
                ...
                console.log(editor.content.scrollHeight,'editor.content.scrollHeight')
                if (o_height !== height){
